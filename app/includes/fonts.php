...
.widget .product_list_widget li > a {
	font:15px/18px 'Roboto', Arial, Helvetica, 'Nimbus Sans L', sans-serif;
	font-weight:300;
	font-style:normal;
}
...
#header .social_icons li:nth-child(1):hover,#middle .social_icons li:nth-child(1):hover, #footer .social_icons li:nth-child(1):hover {border-color:#24bce2;}
